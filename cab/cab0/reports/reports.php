...
if((($_GET['id']>=25) and ($_GET['id']<=29)) or ($_GET['id']==55) or ($_GET['id']==63))
    $query = "SELECT id,hash FROM scsq_groups WHERE id = '".intval($_COOKIE['id'])."' LIMIT 1";
else
...
<p align=right><a href="../logout.php" ><?php echo $_lang['stLOGOUT']; ?></a></p>
