...
//report WHO IPADDRESS VISIT SITE ONE HOUR REPORT
...
$colr[1]="<td>numrow</td>";
$colr[2]="<td><a href=javascript:GoPartlyReports('id',44,'ipaddressid','line2','ipaddressname','line0','typeid','0','hour','".$currenthour."')>line0</a></td>";
